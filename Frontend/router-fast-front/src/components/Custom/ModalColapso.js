...
const ModalColapso = ({ onClose, ruta }) => {
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.infoContainer}>
        <Typography fontWeight='bold' fontSize={16} mb={3}>Rutas de Simulación de 3 días:</Typography>
        {pedidos?.map((nodo, index) => {
          return (
            <>
              <Typography className={classes.infoTitle}>Ruta {index + 1}:</Typography>
