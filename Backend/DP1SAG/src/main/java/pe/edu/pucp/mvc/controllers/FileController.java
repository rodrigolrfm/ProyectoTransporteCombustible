...
public class FileController
{
    ...
    public JsonObject simular(){
        ...
        try {
            ...
            Gson dato = new Gson();
            //dato = dato.fromJson(path, JsonObject.class);
            JsonObject dato1 = dato.fromJson(path, JsonObject.class);
            convertedObject = dato1;
    ...
    @PostMapping("/simularRutasColapso")
    public JsonObject simularColapso(){
        JsonObject convertedObject=null;
        String cadena= "";
        String total = "";
        JSONObject jsonObject =null;
        String archivo="D:\\CICLO10\\Trabajo\\Grupo2\\Download\\json2rutas.txt";
        //String archivo="/home/ubuntu/Grupo2/Download/json2rutas.txt";
        String data = "";
    ...
    @PostMapping(value = "/uploadPedidos", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public String fileUploadPedidos(@RequestParam("file") MultipartFile file) throws IOException
    {
    ...
    @PostMapping(value = "/uploadBloqueos", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public String fileUploadBloqueos(@RequestParam("file") MultipartFile file) throws IOException
    {
        File convertFile = new File("/home/ubuntu/resources/" + file.getOriginalFilename());
        //File convertFile = new File("D:/work/" + file.getOriginalFilename());
        convertFile.createNewFile();
