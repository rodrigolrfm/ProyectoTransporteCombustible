...
private int splitSimple(Individual indiv)
  ...
  public Split(Params params)
  {
	  ...
	  potential = VectorHelper.nestedArrayList(params.nbVehicles + 1, params.nbClients + 1, 1.e30);
	  pred = VectorHelper.nestedArrayList(params.nbVehicles + 1, params.nbClients + 1, 0);
  }    
